 ...
 *
 * 用法：
 *   node ./scripts/tagMerger/tagMergerCli.ts                # dry-run：生成映射建议
 *   node ./scripts/tagMerger/tagMergerCli.ts --apply        # 将映射写回源文件
 *   node ./scripts/tagMerger/tagMergerCli.ts --locale en    # 处理英文标签
 *   node ./scripts/tagMerger/tagMergerCli.ts --force        # 忽略已有映射文件重新生成
 */
