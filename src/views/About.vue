          ...
          <section>
            ...
            <div class="ms-3">
              <div v-for="(edu, idx) in data.education" :key="idx" class="mb-4">
                <h3 class="h6 fw-semibold text-body-emphasis mb-1">{{ edu.degree }}</h3>
                <p class="text-muted mb-1 small">
                  <strong>{{ edu.institution }}</strong> · {{ edu.duration }}
                </p>
                <p class="text-muted mb-0 small">{{ edu.desc }}</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div class="ms-3">
              <div v-for="(skill, idx) in data.skills" :key="idx" class="mb-4">
                <h3 class="h6 fw-semibold text-body-emphasis mb-1">{{ skill.name }}</h3>
                <p class="text-muted mb-1 small">{{ skill.level }}</p>
                <p class="text-muted mb-0 small">{{ skill.tools }}</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div class="ms-3">
              <div v-for="(project, idx) in data.projects" :key="idx" class="mb-4">
                <h3 class="h6 fw-semibold text-body-emphasis mb-1">{{ project.title }}</h3>
                <p class="text-muted mb-1 small">
                  <strong>{{ project.role }}</strong> · {{ project.duration }}
                </p>
                <p class="text-muted mb-0 small">{{ project.desc }}</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div class="ms-3">
              <div v-for="(award, idx) in data.awards" :key="idx" class="mb-3">
                <h3 class="h6 fw-semibold text-body-emphasis mb-0">{{ award.title }}</h3>
